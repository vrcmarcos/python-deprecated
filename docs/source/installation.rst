...
We recommend using the latest version of Python 3. Python-Deprecated supports Python 3.3
...
If you want to work with the latest Python-Deprecated code before it's released, install or
